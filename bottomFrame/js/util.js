var util = {
	...
	myInit:function createWebview() {
		var nw=null;
				nw = nw || plus.webview.create('index.html', 'index.html', {
					popGesture: 'hide',
					subNViews: [{
						id: 'tabBar',
						styles: {
...
//		alert(plus.nativeObj.View.getViewById("tabBar"));
//alert(plus.webview.currentWebview().getStyle().subNViews[0]);
